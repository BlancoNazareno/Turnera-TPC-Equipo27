<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSiteMaster.Master" AutoEventWireup="true" CodeBehind="FormTurno.aspx.cs" Inherits="Turnera_TPC_Equipo27.FormTurno" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" style="background-color: rgb(65, 65, 65);">
        <div class="text-light p-3 text-center" style="margin-top: 3rem; margin-bottom: 2rem">
            ...
            <br />
            <p>Formulario para dar de alta los turnos, desde el lado del admin</p>
        </div>
    </div>
    ...
    <div class="row d-flex justify-content-center ">
        <div class="col-6 mb-3 text-center">
            <label for="ddlMedico" class="form-label text-white" id="lblMedico" runat="server"><strong>Médico</strong></label>
